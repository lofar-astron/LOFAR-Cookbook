...
#
# plot pardb solutions on a single page for all stations
# python plot_solutions_all_stations_v2.py -h for help
#  
# usage: python monitorjob.py <pid> <imagename>
# written by: Wendy Williams wwilliams@strw.leidenuniv.nl
# original: 26 May 2014
...
def solplot_scalarphase(parmdb, imageroot, refstationi, plot_international=False, stations=[]):
    ...
    for istat, station in enumerate(stationsnames):
        ...
        axs[istat][0].text(0.5, 0.9, station, horizontalalignment='center',
                           verticalalignment='center', transform=axs[istat][0].transAxes,
...
def solplot_tec(parmdb, imageroot, refstationi, plot_international=False, freq=None, stations=[]):
    parmdbmtable = lp.parmdb(parmdb)
    soldict = parmdbmtable.getValuesGrid('*')
...
def solplot_clock(parmdb, imageroot, refstationi, plot_international=False, stations=[]):
    parmdbmtable = lp.parmdb(parmdb)
    soldict = parmdbmtable.getValuesGrid('*')
    names = parmdbmtable.getNames()
...
def solplot_phase_phasors(parmdb, imageroot, refstationi, plot_international=False, stations=[]):
    parmdbmtable = lp.parmdb(parmdb)
    soldict = parmdbmtable.getValuesGrid('*')
    names = parmdbmtable.getNames()
...
def solplot_phase(parmdb, imageroot, refstationi, norm_amp_lim=False, median_amp=False, plot_international=False, stations=[]):
    ...
    for istat, station in enumerate(stationsnames):
        ...
        axsp[istat][0].text(0.5, 0.9, station, horizontalalignment='center',
                            verticalalignment='center', transform=axsp[istat][0].transAxes,
                            backgroundcolor='white', color='k')
...
def solplot_amp(parmdb, imageroot, refstationi, norm_amp_lim=False, median_amp=False, plot_international=False, stations=[]):
    ...
    for istat, station in enumerate(stationsnames):
        ...
        axsa[istat][0].text(0.5, 0.9, station, horizontalalignment='center',
                            verticalalignment='center', transform=axsa[istat][0].transAxes,
                            backgroundcolor='white', color='k')
...
def main():
    ...
    parser.add_argument('--stations', dest='stations', default='', help="station list (default all)")
    ...
    if args.scalarphase:
        solplot_scalarphase(parmdb, imageroot, refstation, plot_international=plot_international, stations=stations)
        
    if args.phase:
        if args.phasors:
            solplot_phase_phasors(parmdb, imageroot, refstation, plot_international=plot_international, stations=stations)
        else:
            solplot_phase(parmdb, imageroot, refstation, plot_international=plot_international, stations=stations)
    
    if args.amp:
        solplot_amp(parmdb, imageroot, refstation, norm_amp_lim=norm_amp_lim, median_amp=median_amp, plot_international=plot_international, stations=stations)
        
        
    if args.tec:
        solplot_tec(parmdb, imageroot, refstation, plot_international=plot_international, freq=reffreq, stations=stations)
        
    if args.clock:
        solplot_clock(parmdb, imageroot, refstation, plot_international=plot_international, stations=stations)

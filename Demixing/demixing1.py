...
avg_msnames = ['L23145_SB030_HydA_avg.MS',
               'L23145_SB030_CygA_avg.MS',
               'L23145_SB030_CasA_avg.MS']
...
for avg_msname in avg_msnames :
   ...
   avg_dem_msnames.append(avg_dem_msnames)
...
A = numpy.zeros((len(w_list), len(w_list), N_pol, N_cell_in_freq, N_baselines), dtype=numpy.complex128)
Ainv = numpy.zeros((len(w_list), len(w_list), N_pol, N_cell_in_freq, N_baselines), dtype=numpy.complex128)
